...
public class Ex {
    ...
    static double customerWaitingTime(double lastArrival, double theta){
        Random x = new Random();
        return (double) (lastArrival +(-1*(Math.log(1-x.nextDouble())* theta)));
